...
const USER_GET_SERVICE_REST_API_URL =
  "http://localhost:5555/api/service1/getalluser";

const USER_POST_SERVICE_REST_API_URL =
  "http://localhost:5555/api/service1/postuser";

const USER_GET_BY_NAME_SERVICE_REST_API_URL =
  "http://localhost:5555/api/service1/getuserdata/";

const USER_DELETE_SERVICE_REST_API_URL =
  "http://localhost:5555/api/service1//deleteuser/";
